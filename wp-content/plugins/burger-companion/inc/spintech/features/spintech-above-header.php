...
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	//Pro feature
		class Spintech_social_section_upgrade extends WP_Customize_Control {
			...
			?>
				<a class="customizer_spintech_social_upgrade_section up-to-pro" href="https://burgerthemes.com/downloads/spintech-pro/" target="_blank" style="display: none;"><?php _e('More Icons Available in Spintech Pro','spintech'); ?></a>
			<?php
			}
		}
