...
jQuery(document).ready(function () {
    ...
    burger_companion_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        ...
        {
        if(jQuery('#exist_burger_companion_Spintech_Slider').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Slider').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Slider').val())+1;
         jQuery('#exist_burger_companion_Spintech_Slider').val(new_service_add_val);  
        }
        }
		
		 if(split_add_more_button_split=="Add New Serv")
        {
        if(jQuery('#exist_burger_companion_Spintech_Service').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Service').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Service').val())+1;
         jQuery('#exist_burger_companion_Spintech_Service').val(new_service_add_val);  
        }
        }
         if(split_add_more_button_split=="Add New Info")
        {
        if(jQuery('#exist_burger_companion_Spintech_Information').val()>=4)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Information').val()<4)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Information').val())+1;
         jQuery('#exist_burger_companion_Spintech_Information').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Soci")
        {
        if(jQuery('#exist_burger_companion_Spintech_Social').val()>=3)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Social').val()<3)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Social').val())+1;
         jQuery('#exist_burger_companion_Spintech_Social').val(new_service_add_val);  
        }
        }
		
		if(split_add_more_button_split=="Add New Desi")
        {
        if(jQuery('#exist_burger_companion_Spintech_Design').val()>=8)
        {
        ...
        return false;   
         ...
         if(jQuery('#exist_burger_companion_Spintech_Design').val()<8)
        {
         var new_service_add_val=parseInt(jQuery('#exist_burger_companion_Spintech_Design').val())+1;
         jQuery('#exist_burger_companion_Spintech_Design').val(new_service_add_val);  
        }
        }
    ...
    burger_companion_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                {
                jQuery('#exist_burger_companion_Spintech_Slider').val(parseInt(jQuery('#exist_burger_companion_Spintech_Slider').val())-1);  
                }
				if(split_delete_button_split=="Delete Servi")
                {
                jQuery('#exist_burger_companion_Spintech_Service').val(parseInt(jQuery('#exist_burger_companion_Spintech_Service').val())-1);  
                }
				if(split_delete_button_split=="Delete Infor")
                {
                jQuery('#exist_burger_companion_Spintech_Information').val(parseInt(jQuery('#exist_burger_companion_Spintech_Information').val())-1); 
                }
				if(split_delete_button_split=="Delete Socia")
                {
                jQuery('#exist_burger_companion_Spintech_Social').val(parseInt(jQuery('#exist_burger_companion_Spintech_Social').val())-1); 
                }
				if(split_delete_button_split=="Delete Desig")
                {
                jQuery('#exist_burger_companion_Spintech_Design').val(parseInt(jQuery('#exist_burger_companion_Spintech_Design').val())-1); 
                }
